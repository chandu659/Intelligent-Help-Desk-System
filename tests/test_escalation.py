...
class TestEscalationHandler(unittest.TestCase):
    ...
    def test_should_escalate_automatic_category(self):
        ...
        self.assertTrue(should_escalate)
        self.assertIn("Automatic escalation for category: hardware_failure", reason)
    ...
    def test_should_escalate_security_incident(self):
        ...
        self.assertIn("Security incident requires escalation", reason)
    ...
    def test_get_escalation_message(self):
        ...
        self.assertIn("Account Security Team", message)  
        self.assertIn("support specialist", message.lower())  
